...
## Boolean query LinkedIn (copy-paste)

**Target primario — agenti plurimandatari Nord Italia:**
```
"agente di commercio" AND ("plurimandatario" OR "plurimandato" OR "rappresentante")
```
Filtri: Italia, 2nd degree, Attività recente "Ultimi 30 giorni"

**Per settore (usare una alla volta):**
```
"agente di commercio" AND "farmaceutico"
"agente di commercio" AND ("food" OR "alimentare" OR "beverage")
"agente di commercio" AND ("ferramenta" OR "utensileria" OR "industriale")
"agente di commercio" AND ("arredo" OR "arredamento" OR "design")
"agente di commercio" AND ("abbigliamento" OR "moda" OR "textile")
"agente di commercio" AND ("medicale" OR "dispositivi medici")
```

**Per città ad alta densità (Nord):**
Milano · Torino · Bologna · Brescia · Bergamo · Verona · Padova · Vicenza · Modena · Parma

---

## Template DM (10 varianti — scegliere in base al profilo)

### DM #1 — Plurimandatario generico (cold baseline)
```
Ciao [Nome],
...
### DM #2 — Farmaceutico / informatore scientifico
```
Ciao [Nome],
...
### DM #4 — Ferramenta / industriale / edilizia
```
Ciao [Nome],
...
### DM #7 — Signal: ha postato su "tempo perso in burocrazia"
```
Ciao [Nome],
...
### DM #8 — Signal: ha commentato/condiviso contenuto AI o ChatGPT
```
Ciao [Nome],
...
### DM #9 — Peer proof (quando avrai il primo cliente)
```
Ciao [Nome],
...
## Follow-up (giorno +4 se nessuna risposta)
...
## Tracking Sheet — Batch 01

Compila durante l'invio. Obiettivo batch: **1-2 trial entro 7 giorni, 1 pagante entro 14 giorni**.

| # | Nome | Azienda / Settore | Città | Template DM | Connessione inviata | Accettata | DM inviato | Risposta | Outcome | Note |
|---|------|-------------------|-------|-------------|--------------------|-----------|------------|----------|---------|------|
| 1 |      |                   |       |             |                    |           |            |          |         |      |
| 2 |      |                   |       |             |                    |           |            |          |         |      |
| 3 |      |                   |       |             |                    |           |            |          |         |      |
...
**Legenda Outcome:** `ignored` · `declined` · `interested` · `trial_signup` · `paid`

---

## Routine giornaliera (30 min, Mar/Mer/Gio ore 8:30-9:00 o 12:00-12:30)

1. **5 min** — Apri LinkedIn, cerca con una boolean query sopra, scrolla 10 profili
2. **10 min** — Manda 10 connection request (con nota breve di 1 riga, no link, no pitch)
   > "Ciao [Nome], lavoro su strumenti AI per agenti di commercio italiani. Mi interessa confrontarmi con chi è nel settore. Ci connetto?"
...
## Metriche settimanali da monitorare

| Settimana 1 | Target | Effettivo |
|---|---|---|
| Connection request inviate | 50-70 | |
| Accettate | 15-25 (30%+) | |
| DM inviati | 15-25 | |
| Risposte ricevute | 2-4 (10-15%) | |
| Trial attivati | 1-2 | |
| Paganti | 0-1 | |

**Se a fine settimana 1 meno di 10 accettazioni → rivedere la nota di connessione.**
**Se a fine settimana 1 zero risposte → cambiare hook nei DM (passare da "risparmio tempo" a "risparmio soldi").**

---

## Next step dopo batch 01

1. **A/B test nota di connessione** — provare 2 varianti per 50 request ciascuna
2. **Post LinkedIn di Roberto** "Come ho usato l'AI per automatizzare i miei report di visita" — genera inbound, +30% accept rate
3. **Chiedere referral al primo cliente** — mese gratis per ogni agente referralato
4. **Switch Stripe TEST → LIVE** appena un trial dice "voglio pagare"
